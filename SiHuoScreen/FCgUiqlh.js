...
}`;function V_(i,e,t){let n=new ic;const s=new oe,r=new oe,o=new tt,a=new B_({depthPacking:Sf}),c=new z_,l={},u=t.maxTextureSize,h={[Cn]:Bt,[Bt]:Cn,[an]:an},f=new Kn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new oe},radius:{value:4}},vertexShader:k_,fragmentShader:H_}),d=f.clone();d.defines.HORIZONTAL_PASS=1;const g=new Jt;g.setAttribute("position",new Ut(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new bt(g,f),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=gu;let m=this.type;this.render=function(R,w,N){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||R.length===0)return;const T=i.getRenderTarget(),S=i.getActiveCubeFace(),P=i.getActiveMipmapLevel(),Y=i.state;Y.setBlending(Xn),Y.buffers.color.setClear(1,1,1,1),Y.buffers.depth.setTest(!0),Y.setScissorTest(!1);const B=m!==Tn&&this.type===Tn,z=m===Tn&&this.type!==Tn;for(let D=0,O=R.length;D<O;D++){const j=R[D],W=j.shadow;if(W===void 0){console.warn("THREE.WebGLShadowMap:",j,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;s.copy(W.mapSize);const ce=W.getFrameExtents();if(s.multiply(ce),r.copy(W.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/ce.x),s.x=r.x*ce.x,W.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/ce.y),s.y=r.y*ce.y,W.mapSize.y=r.y)),W.map===null||B===!0||z===!0){const J=this.type!==Tn?{minFilter:Pt,magFilter:Pt}:{};W.map!==null&&W.map.dispose(),W.map=new ci(s.x,s.y,J),W.map.texture.name=j.name+".shadowMap",W.camera.updateProjectionMatrix()}i.setRenderTarget(W.map),i.clear();const pe=W.getViewportCount();for(let J=0;J<pe;J++){const ue=W.getViewport(J);o.set(r.x*ue.x,r.y*ue.y,r.x*ue.z,r.y*ue.w),Y.viewport(o),W.updateMatrices(j,J),n=W.getFrustum(),y(w,N,W.camera,j,this.type)}W.isPointLightShadow!==!0&&this.type===Tn&&E(W,N),W.needsUpdate=!1}m=this.type,p.needsUpdate=!1,i.setRenderTarget(T,S,P)};function E(R,w){const N=e.update(_);f.defines.VSM_SAMPLES!==R.blurSamples&&(f.defines.VSM_SAMPLES=R.blurSamples,d.defines.VSM_SAMPLES=R.blurSamples,f.needsUpdate=!0,d.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new ci(s.x,s.y)),f.uniforms.shadow_pass.value=R.map.texture,f.uniforms.resolution.value=R.mapSize,f.uniforms.radius.value=R.radius,i.setRenderTarget(R.mapPass),i.clear(),i.renderBufferDirect(w,null,N,f,_,null),d.uniforms.shadow_pass.value=R.mapPass.texture,d.uniforms.resolution.value=R.mapSize,d.uniforms.radius.value=R.radius,i.setRenderTarget(R.map),i.clear(),i.renderBufferDirect(w,null,N,d,_,null)}function v(R,w,N,T){let S=null;const P=N.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(P!==void 0)S=P;else if(S=N.isPointLight===!0?c:a,i.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0){const Y=S.uuid,B=w.uuid;let z=l[Y];z===void 0&&(z={},l[Y]=z);let D=z[B];D===void 0&&(D=S.clone(),z[B]=D,w.addEventListener("dispose",L)),S=D}if(S.visible=w.visible,S.wireframe=w.wireframe,T===Tn?S.side=w.shadowSide!==null?w.shadowSide:w.side:S.side=w.shadowSide!==null?w.shadowSide:h[w.side],S.alphaMap=w.alphaMap,S.alphaTest=w.alphaTest,S.map=w.map,S.clipShadows=w.clipShadows,S.clippingPlanes=w.clippingPlanes,S.clipIntersection=w.clipIntersection,S.displacementMap=w.displacementMap,S.displacementScale=w.displacementScale,S.displacementBias=w.displacementBias,S.wireframeLinewidth=w.wireframeLinewidth,S.linewidth=w.linewidth,N.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const Y=i.properties.get(S);Y.light=N}return S}function y(R,w,N,T,S){if(R.visible===!1)return;if(R.layers.test(w.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&S===Tn)&&(!R.frustumCulled||n.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(N.matrixWorldInverse,R.matrixWorld);const B=e.update(R),z=R.material;if(Array.isArray(z)){const D=B.groups;for(let O=0,j=D.length;O<j;O++){const W=D[O],ce=z[W.materialIndex];if(ce&&ce.visible){const pe=v(R,ce,T,S);R.onBeforeShadow(i,R,w,N,B,pe,W),i.renderBufferDirect(N,null,B,pe,R,W),R.onAfterShadow(i,R,w,N,B,pe,W)}}}else if(z.visible){const D=v(R,z,T,S);R.onBeforeShadow(i,R,w,N,B,D,null),i.renderBufferDirect(N,null,B,D,R,null),R.onAfterShadow(i,R,w,N,B,D,null)}}const Y=R.children;for(let B=0,z=Y.length;B<z;B++)y(Y[B],w,N,T,S)}function L(R){R.target.removeEventListener("dispose",L);for(const N in l){const T=l[N],S=R.target.uuid;S in T&&(T[S].dispose(),delete T[S])}}}function G_(i){function e(){let x=!1;const k=new tt;let V=null;const K=new tt(0,0,0,0);return{setMask:function(ie){V!==ie&&!x&&(i.colorMask(ie,ie,ie,ie),V=ie)},setLocked:function(ie){x=ie},setClear:function(ie,Re,Oe,ut,_t){_t===!0&&(ie*=ut,Re*=ut,Oe*=ut),k.set(ie,Re,Oe,ut),K.equals(k)===!1&&(i.clearColor(ie,Re,Oe,ut),K.copy(k))},reset:function(){x=!1,V=null,K.set(-1,0,0,0)}}}function t(){let x=!1,k=null,V=null,K=null;return{setTest:function(ie){ie?ge(i.DEPTH_TEST):se(i.DEPTH_TEST)},setMask:function(ie){k!==ie&&!x&&(i.depthMask(ie),k=ie)},setFunc:function(ie){if(V!==ie){switch(ie){case Qh:i.depthFunc(i.NEVER);break;case ef:i.depthFunc(i.ALWAYS);break;case tf:i.depthFunc(i.LESS);break;case Ir:i.depthFunc(i.LEQUAL);break;case nf:i.depthFunc(i.EQUAL);break;case sf:i.depthFunc(i.GEQUAL);break;case rf:i.depthFunc(i.GREATER);break;case of:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}V=ie}},setLocked:function(ie){x=ie},setClear:function(ie){K!==ie&&(i.clearDepth(ie),K=ie)},reset:function(){x=!1,k=null,V=null,K=null}}}function n(){let x=!1,k=null,V=null,K=null,ie=null,Re=null,Oe=null,ut=null,_t=null;return{setTest:function(Ke){x||(Ke?ge(i.STENCIL_TEST):se(i.STENCIL_TEST))},setMask:function(Ke){k!==Ke&&!x&&(i.stencilMask(Ke),k=Ke)},setFunc:function(Ke,vt,dt){(V!==Ke||K!==vt||ie!==dt)&&(i.stencilFunc(Ke,vt,dt),V=Ke,K=vt,ie=dt)},setOp:function(Ke,vt,dt){(Re!==Ke||Oe!==vt||ut!==dt)&&(i.stencilOp(Ke,vt,dt),Re=Ke,Oe=vt,ut=dt)},setLocked:function(Ke){x=Ke},setClear:function(Ke){_t!==Ke&&(i.clearStencil(Ke),_t=Ke)},reset:function(){x=!1,k=null,V=null,K=null,ie=null,Re=null,Oe=null,ut=null,_t=null}}}const s=new e,r=new t,o=new n,a=new WeakMap,c=new WeakMap;let l={},u={},h=new WeakMap,f=[],d=null,g=!1,_=null,p=null,m=null,E=null,v=null,y=null,L=null,R=new ke(0,0,0),w=0,N=!1,T=null,S=null,P=null,Y=null,B=null;const z=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let D=!1,O=0;const j=i.getParameter(i.VERSION);j.indexOf("WebGL")!==-1?(O=parseFloat(/^WebGL (\d)/.exec(j)[1]),D=O>=1):j.indexOf("OpenGL ES")!==-1&&(O=parseFloat(/^OpenGL ES (\d)/.exec(j)[1]),D=O>=2);let W=null,ce={};const pe=i.getParameter(i.SCISSOR_BOX),J=i.getParameter(i.VIEWPORT),ue=new tt().fromArray(pe),xe=new tt().fromArray(J);function X(x,k,V,K){const ie=new Uint8Array(4),Re=i.createTexture();i.bindTexture(x,Re),i.texParameteri(x,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(x,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Oe=0;Oe<V;Oe++)x===i.TEXTURE_3D||x===i.TEXTURE_2D_ARRAY?i.texImage3D(k,0,i.RGBA,1,1,K,0,i.RGBA,i.UNSIGNED_BYTE,ie):i.texImage2D(k+Oe,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ie);return Re}const $={};$[i.TEXTURE_2D]=X(i.TEXTURE_2D,i.TEXTURE_2D,1),$[i.TEXTURE_CUBE_MAP]=X(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),$[i.TEXTURE_2D_ARRAY]=X(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),$[i.TEXTURE_3D]=X(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),r.setClear(1),o.setClear(0),ge(i.DEPTH_TEST),r.setFunc(Ir),he(!1),Z(Tc),ge(i.CULL_FACE),re(Xn);function ge(x){l[x]!==!0&&(i.enable(x),l[x]=!0)}function se(x){l[x]!==!1&&(i.disable(x),l[x]=!1)}function Ae(x,k){return u[x]!==k?(i.bindFramebuffer(x,k),u[x]=k,x===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=k),x===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=k),!0):!1}function Ie(x,k){let V=f,K=!1;if(x){V=h.get(k),V===void 0&&(V=[],h.set(k,V));const ie=x.textures;if(V.length!==ie.length||V[0]!==i.COLOR_ATTACHMENT0){for(let Re=0,Oe=ie.length;Re<Oe;Re++)V[Re]=i.COLOR_ATTACHMENT0+Re;V.length=ie.length,K=!0}}else V[0]!==i.BACK&&(V[0]=i.BACK,K=!0);K&&i.drawBuffers(V)}function be(x){return d!==x?(i.useProgram(x),d=x,!0):!1}const We={[ri]:i.FUNC_ADD,[Oh]:i.FUNC_SUBTRACT,[Fh]:i.FUNC_REVERSE_SUBTRACT};We[Bh]=i.MIN,We[zh]=i.MAX;const b={[kh]:i.ZERO,[Hh]:i.ONE,[Vh]:i.SRC_COLOR,[Xo]:i.SRC_ALPHA,[Kh]:i.SRC_ALPHA_SATURATE,[qh]:i.DST_COLOR,[Wh]:i.DST_ALPHA,[Gh]:i.ONE_MINUS_SRC_COLOR,[qo]:i.ONE_MINUS_SRC_ALPHA,[Yh]:i.ONE_MINUS_DST_COLOR,[Xh]:i.ONE_MINUS_DST_ALPHA,[jh]:i.CONSTANT_COLOR,[Zh]:i.ONE_MINUS_CONSTANT_COLOR,[Jh]:i.CONSTANT_ALPHA,[$h]:i.ONE_MINUS_CONSTANT_ALPHA};function re(x,k,V,K,ie,Re,Oe,ut,_t,Ke){if(x===Xn){g===!0&&(se(i.BLEND),g=!1);return}if(g===!1&&(ge(i.BLEND),g=!0),x!==Uh){if(x!==_||Ke!==N){if((p!==ri||v!==ri)&&(i.blendEquation(i.FUNC_ADD),p=ri,v=ri),Ke)switch(x){case Bi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ac:i.blendFunc(i.ONE,i.ONE);break;case bc:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case wc:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",x);break}else switch(x){case Bi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ac:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case bc:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case wc:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",x);break}m=null,E=null,y=null,L=null,R.set(0,0,0),w=0,_=x,N=Ke}return}ie=ie||k,Re=Re||V,Oe=Oe||K,(k!==p||ie!==v)&&(i.blendEquationSeparate(We[k],We[ie]),p=k,v=ie),(V!==m||K!==E||Re!==y||Oe!==L)&&(i.blendFuncSeparate(b[V],b[K],b[Re],b[Oe]),m=V,E=K,y=Re,L=Oe),(ut.equals(R)===!1||_t!==w)&&(i.blendColor(ut.r,ut.g,ut.b,_t),R.copy(ut),w=_t),_=x,N=!1}function ne(x,k){x.side===an?se(i.CULL_FACE):ge(i.CULL_FACE);let V=x.side===Bt;k&&(V=!V),he(V),x.blending===Bi&&x.transparent===!1?re(Xn):re(x.blending,x.blendEquation,x.blendSrc,x.blendDst,x.blendEquationAlpha,x.blendSrcAlpha,x.blendDstAlpha,x.blendColor,x.blendAlpha,x.premultipliedAlpha),r.setFunc(x.depthFunc),r.setTest(x.depthTest),r.setMask(x.depthWrite),s.setMask(x.colorWrite);const K=x.stencilWrite;o.setTest(K),K&&(o.setMask(x.stencilWriteMask),o.setFunc(x.stencilFunc,x.stencilRef,x.stencilFuncMask),o.setOp(x.stencilFail,x.stencilZFail,x.stencilZPass)),de(x.polygonOffset,x.polygonOffsetFactor,x.polygonOffsetUnits),x.alphaToCoverage===!0?ge(i.SAMPLE_ALPHA_TO_COVERAGE):se(i.SAMPLE_ALPHA_TO_COVERAGE)}function he(x){T!==x&&(x?i.frontFace(i.CW):i.frontFace(i.CCW),T=x)}function Z(x){x!==Ih?(ge(i.CULL_FACE),x!==S&&(x===Tc?i.cullFace(i.BACK):x===Nh?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):se(i.CULL_FACE),S=x}function Ce(x){x!==P&&(D&&i.lineWidth(x),P=x)}function de(x,k,V){x?(ge(i.POLYGON_OFFSET_FILL),(Y!==k||B!==V)&&(i.polygonOffset(k,V),Y=k,B=V)):se(i.POLYGON_OFFSET_FILL)}function ye(x){x?ge(i.SCISSOR_TEST):se(i.SCISSOR_TEST)}function C(x){x===void 0&&(x=i.TEXTURE0+z-1),W!==x&&(i.activeTexture(x),W=x)}function M(x,k,V){V===void 0&&(W===null?V=i.TEXTURE0+z-1:V=W);let K=ce[V];K===void 0&&(K={type:void 0,texture:void 0},ce[V]=K),(K.type!==x||K.texture!==k)&&(W!==V&&(i.activeTexture(V),W=V),i.bindTexture(x,k||$[x]),K.type=x,K.texture=k)}function H(){const x=ce[W];x!==void 0&&x.type!==void 0&&(i.bindTexture(x.type,null),x.type=void 0,x.texture=void 0)}function Q(){try{i.compressedTexImage2D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function te(){try{i.compressedTexImage3D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function ee(){try{i.texSubImage2D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function we(){try{i.texSubImage3D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function fe(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function ve(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function Be(){try{i.texStorage2D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function ae(){try{i.texStorage3D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function _e(){try{i.texImage2D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function qe(){try{i.texImage3D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function Ne(x){ue.equals(x)===!1&&(i.scissor(x.x,x.y,x.z,x.w),ue.copy(x))}function Se(x){xe.equals(x)===!1&&(i.viewport(x.x,x.y,x.z,x.w),xe.copy(x))}function Ue(x,k){let V=c.get(k);V===void 0&&(V=new WeakMap,c.set(k,V));let K=V.get(x);K===void 0&&(K=i.getUniformBlockIndex(k,x.name),V.set(x,K))}function ze(x,k){const K=c.get(k).get(x);a.get(k)!==K&&(i.uniformBlockBinding(k,K,x.__bindingPointIndex),a.set(k,K))}function rt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),l={},W=null,ce={},u={},h=new WeakMap,f=[],d=null,g=!1,_=null,p=null,m=null,E=null,v=null,y=null,L=null,R=new ke(0,0,0),w=0,N=!1,T=null,S=null,P=null,Y=null,B=null,ue.set(0,0,i.canvas.width,i.canvas.height),xe.set(0,0,i.canvas.width,i.canvas.height),s.reset(),r.reset(),o.reset()}return{buffers:{color:s,depth:r,stencil:o},enable:ge,disable:se,bindFramebuffer:Ae,drawBuffers:Ie,useProgram:be,setBlending:re,setMaterial:ne,setFlipSided:he,setCullFace:Z,setLineWidth:Ce,setPolygonOffset:de,setScissorTest:ye,activeTexture:C,bindTexture:M,unbindTexture:H,compressedTexImage2D:Q,compressedTexImage3D:te,texImage2D:_e,texImage3D:qe,updateUBOMapping:Ue,uniformBlockBinding:ze,texStorage2D:Be,texStorage3D:ae,texSubImage2D:ee,texSubImage3D:we,compressedTexSubImage2D:fe,compressedTexSubImage3D:ve,scissor:Ne,viewport:Se,reset:rt}}function yl(i,e,t,n){const s=W_(n);switch(t){case Su:return i*e;case Tu:return i*e;case Au:return i*e*2;case Ya:return i*e/s.components*s.byteLength;case Ka:return i*e/s.components*s.byteLength;case bu:return i*e*2/s.components*s.byteLength;case ja:return i*e*2/s.components*s.byteLength;case Eu:return i*e*3/s.components*s.byteLength;case Kt:return i*e*4/s.components*s.byteLength;case Za:return i*e*4/s.components*s.byteLength;case Ar:case br:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case wr:case Rr:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Zo:case $o:return Math.max(i,16)*Math.max(e,8)/4;case jo:case Jo:return Math.max(i,8)*Math.max(e,8)/2;case Qo:case ea:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case ta:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case na:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case ia:return Math.floor((i+4)/5)*Math.floor((e+3)/4)*16;case sa:return Math.floor((i+4)/5)*Math.floor((e+4)/5)*16;case ra:return Math.floor((i+5)/6)*Math.floor((e+4)/5)*16;case oa:return Math.floor((i+5)/6)*Math.floor((e+5)/6)*16;case aa:return Math.floor((i+7)/8)*Math.floor((e+4)/5)*16;case ca:return Math.floor((i+7)/8)*Math.floor((e+5)/6)*16;case la:return Math.floor((i+7)/8)*Math.floor((e+7)/8)*16;case ua:return Math.floor((i+9)/10)*Math.floor((e+4)/5)*16;case ha:return Math.floor((i+9)/10)*Math.floor((e+5)/6)*16;case fa:return Math.floor((i+9)/10)*Math.floor((e+7)/8)*16;case da:return Math.floor((i+9)/10)*Math.floor((e+9)/10)*16;case pa:return Math.floor((i+11)/12)*Math.floor((e+9)/10)*16;case ma:return Math.floor((i+11)/12)*Math.floor((e+11)/12)*16;case Cr:case ga:case _a:return Math.ceil(i/4)*Math.ceil(e/4)*16;case wu:case va:return Math.ceil(i/4)*Math.ceil(e/4)*8;case xa:case ya:return Math.ceil(i/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function W_(i){switch(i){case Pn:case xu:return{byteLength:1,components:1};case ws:case yu:case Fs:return{byteLength:2,components:1};case Xa:case qa:return{byteLength:2,components:4};case ai:case Wa:case sn:return{byteLength:4,components:1};case Mu:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function X_(i,e,t,n,s,r,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new oe,u=new WeakMap;let h;const f=new WeakMap;let d=!1;try{d=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(C,M){return d?new OffscreenCanvas(C,M):Ps("canvas")}function _(C,M,H){let Q=1;const te=ye(C);if((te.width>H||te.height>H)&&(Q=H/Math.max(te.width,te.height)),Q<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){const ee=Math.floor(Q*te.width),we=Math.floor(Q*te.height);h===void 0&&(h=g(ee,we));const fe=M?g(ee,we):h;return fe.width=ee,fe.height=we,fe.getContext("2d").drawImage(C,0,0,ee,we),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+te.width+"x"+te.height+") to ("+ee+"x"+we+")."),fe}else return"data"in C&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+te.width+"x"+te.height+")."),C;return C}function p(C){return C.generateMipmaps&&C.minFilter!==Pt&&C.minFilter!==Ot}function m(C){i.generateMipmap(C)}function E(C,M,H,Q,te=!1){if(C!==null){if(i[C]!==void 0)return i[C];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let ee=M;if(M===i.RED&&(H===i.FLOAT&&(ee=i.R32F),H===i.HALF_FLOAT&&(ee=i.R16F),H===i.UNSIGNED_BYTE&&(ee=i.R8)),M===i.RED_INTEGER&&(H===i.UNSIGNED_BYTE&&(ee=i.R8UI),H===i.UNSIGNED_SHORT&&(ee=i.R16UI),H===i.UNSIGNED_INT&&(ee=i.R32UI),H===i.BYTE&&(ee=i.R8I),H===i.SHORT&&(ee=i.R16I),H===i.INT&&(ee=i.R32I)),M===i.RG&&(H===i.FLOAT&&(ee=i.RG32F),H===i.HALF_FLOAT&&(ee=i.RG16F),H===i.UNSIGNED_BYTE&&(ee=i.RG8)),M===i.RG_INTEGER&&(H===i.UNSIGNED_BYTE&&(ee=i.RG8UI),H===i.UNSIGNED_SHORT&&(ee=i.RG16UI),H===i.UNSIGNED_INT&&(ee=i.RG32UI),H===i.BYTE&&(ee=i.RG8I),H===i.SHORT&&(ee=i.RG16I),H===i.INT&&(ee=i.RG32I)),M===i.RGB&&H===i.UNSIGNED_INT_5_9_9_9_REV&&(ee=i.RGB9_E5),M===i.RGBA){const we=te?Ur:je.getTransfer(Q);H===i.FLOAT&&(ee=i.RGBA32F),H===i.HALF_FLOAT&&(ee=i.RGBA16F),H===i.UNSIGNED_BYTE&&(ee=we===it?i.SRGB8_ALPHA8:i.RGBA8),H===i.UNSIGNED_SHORT_4_4_4_4&&(ee=i.RGBA4),H===i.UNSIGNED_SHORT_5_5_5_1&&(ee=i.RGB5_A1)}return(ee===i.R16F||ee===i.R32F||ee===i.RG16F||ee===i.RG32F||ee===i.RGBA16F||ee===i.RGBA32F)&&e.get("EXT_color_buffer_float"),ee}function v(C,M){let H;return C?M===null||M===ai||M===qi?H=i.DEPTH24_STENCIL8:M===sn?H=i.DEPTH32F_STENCIL8:M===ws&&(H=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===ai||M===qi?H=i.DEPTH_COMPONENT24:M===sn?H=i.DEPTH_COMPONENT32F:M===ws&&(H=i.DEPTH_COMPONENT16),H}function y(C,M){return p(C)===!0||C.isFramebufferTexture&&C.minFilter!==Pt&&C.minFilter!==Ot?Math.log2(Math.max(M.width,M.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?M.mipmaps.length:1}function L(C){const M=C.target;M.removeEventListener("dispose",L),w(M),M.isVideoTexture&&u.delete(M)}function R(C){const M=C.target;M.removeEventListener("dispose",R),T(M)}function w(C){const M=n.get(C);if(M.__webglInit===void 0)return;const H=C.source,Q=f.get(H);if(Q){const te=Q[M.__cacheKey];te.usedTimes--,te.usedTimes===0&&N(C),Object.keys(Q).length===0&&f.delete(H)}n.remove(C)}function N(C){const M=n.get(C);i.deleteTexture(M.__webglTexture);const H=C.source,Q=f.get(H);delete Q[M.__cacheKey],o.memory.textures--}function T(C){const M=n.get(C);if(C.depthTexture&&C.depthTexture.dispose(),C.isWebGLCubeRenderTarget)for(let Q=0;Q<6;Q++){if(Array.isArray(M.__webglFramebuffer[Q]))for(let te=0;te<M.__webglFramebuffer[Q].length;te++)i.deleteFramebuffer(M.__webglFramebuffer[Q][te]);else i.deleteFramebuffer(M.__webglFramebuffer[Q]);M.__webglDepthbuffer&&i.deleteRenderbuffer(M.__webglDepthbuffer[Q])}else{if(Array.isArray(M.__webglFramebuffer))for(let Q=0;Q<M.__webglFramebuffer.length;Q++)i.deleteFramebuffer(M.__webglFramebuffer[Q]);else i.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&i.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&i.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let Q=0;Q<M.__webglColorRenderbuffer.length;Q++)M.__webglColorRenderbuffer[Q]&&i.deleteRenderbuffer(M.__webglColorRenderbuffer[Q]);M.__webglDepthRenderbuffer&&i.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const H=C.textures;for(let Q=0,te=H.length;Q<te;Q++){const ee=n.get(H[Q]);ee.__webglTexture&&(i.deleteTexture(ee.__webglTexture),o.memory.textures--),n.remove(H[Q])}n.remove(C)}let S=0;function P(){S=0}function Y(){const C=S;return C>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+s.maxTextures),S+=1,C}function B(C){const M=[];return M.push(C.wrapS),M.push(C.wrapT),M.push(C.wrapR||0),M.push(C.magFilter),M.push(C.minFilter),M.push(C.anisotropy),M.push(C.internalFormat),M.push(C.format),M.push(C.type),M.push(C.generateMipmaps),M.push(C.premultiplyAlpha),M.push(C.flipY),M.push(C.unpackAlignment),M.push(C.colorSpace),M.join()}function z(C,M){const H=n.get(C);if(C.isVideoTexture&&Ce(C),C.isRenderTargetTexture===!1&&C.version>0&&H.__version!==C.version){const Q=C.image;if(Q===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Q.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{xe(H,C,M);return}}t.bindTexture(i.TEXTURE_2D,H.__webglTexture,i.TEXTURE0+M)}function D(C,M){const H=n.get(C);if(C.version>0&&H.__version!==C.version){xe(H,C,M);return}t.bindTexture(i.TEXTURE_2D_ARRAY,H.__webglTexture,i.TEXTURE0+M)}function O(C,M){const H=n.get(C);if(C.version>0&&H.__version!==C.version){xe(H,C,M);return}t.bindTexture(i.TEXTURE_3D,H.__webglTexture,i.TEXTURE0+M)}function j(C,M){const H=n.get(C);if(C.version>0&&H.__version!==C.version){X(H,C,M);return}t.bindTexture(i.TEXTURE_CUBE_MAP,H.__webglTexture,i.TEXTURE0+M)}const W={[Yn]:i.REPEAT,[Gn]:i.CLAMP_TO_EDGE,[Nr]:i.MIRRORED_REPEAT},ce={[Pt]:i.NEAREST,[vu]:i.NEAREST_MIPMAP_NEAREST,[ms]:i.NEAREST_MIPMAP_LINEAR,[Ot]:i.LINEAR,[Tr]:i.LINEAR_MIPMAP_NEAREST,[bn]:i.LINEAR_MIPMAP_LINEAR},pe={[Tf]:i.NEVER,[Pf]:i.ALWAYS,[Af]:i.LESS,[Lu]:i.LEQUAL,[bf]:i.EQUAL,[Cf]:i.GEQUAL,[wf]:i.GREATER,[Rf]:i.NOTEQUAL};function J(C,M){if(M.type===sn&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===Ot||M.magFilter===Tr||M.magFilter===ms||M.magFilter===bn||M.minFilter===Ot||M.minFilter===Tr||M.minFilter===ms||M.minFilter===bn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(C,i.TEXTURE_WRAP_S,W[M.wrapS]),i.texParameteri(C,i.TEXTURE_WRAP_T,W[M.wrapT]),(C===i.TEXTURE_3D||C===i.TEXTURE_2D_ARRAY)&&i.texParameteri(C,i.TEXTURE_WRAP_R,W[M.wrapR]),i.texParameteri(C,i.TEXTURE_MAG_FILTER,ce[M.magFilter]),i.texParameteri(C,i.TEXTURE_MIN_FILTER,ce[M.minFilter]),M.compareFunction&&(i.texParameteri(C,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(C,i.TEXTURE_COMPARE_FUNC,pe[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===Pt||M.minFilter!==ms&&M.minFilter!==bn||M.type===sn&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||n.get(M).__currentAnisotropy){const H=e.get("EXT_texture_filter_anisotropic");i.texParameterf(C,H.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,s.getMaxAnisotropy())),n.get(M).__currentAnisotropy=M.anisotropy}}}function ue(C,M){let H=!1;C.__webglInit===void 0&&(C.__webglInit=!0,M.addEventListener("dispose",L));const Q=M.source;let te=f.get(Q);te===void 0&&(te={},f.set(Q,te));const ee=B(M);if(ee!==C.__cacheKey){te[ee]===void 0&&(te[ee]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,H=!0),te[ee].usedTimes++;const we=te[C.__cacheKey];we!==void 0&&(te[C.__cacheKey].usedTimes--,we.usedTimes===0&&N(M)),C.__cacheKey=ee,C.__webglTexture=te[ee].texture}return H}function xe(C,M,H){let Q=i.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(Q=i.TEXTURE_2D_ARRAY),M.isData3DTexture&&(Q=i.TEXTURE_3D);const te=ue(C,M),ee=M.source;t.bindTexture(Q,C.__webglTexture,i.TEXTURE0+H);const we=n.get(ee);if(ee.version!==we.__version||te===!0){t.activeTexture(i.TEXTURE0+H);const fe=je.getPrimaries(je.workingColorSpace),ve=M.colorSpace===Vn?null:je.getPrimaries(M.colorSpace),Be=M.colorSpace===Vn||fe===ve?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Be);let ae=_(M.image,!1,s.maxTextureSize);ae=de(M,ae);const _e=r.convert(M.format,M.colorSpace),qe=r.convert(M.type);let Ne=E(M.internalFormat,_e,qe,M.colorSpace,M.isVideoTexture);J(Q,M);let Se;const Ue=M.mipmaps,ze=M.isVideoTexture!==!0,rt=we.__version===void 0||te===!0,x=ee.dataReady,k=y(M,ae);if(M.isDepthTexture)Ne=v(M.format===Yi,M.type),rt&&(ze?t.texStorage2D(i.TEXTURE_2D,1,Ne,ae.width,ae.height):t.texImage2D(i.TEXTURE_2D,0,Ne,ae.width,ae.height,0,_e,qe,null));else if(M.isDataTexture)if(Ue.length>0){ze&&rt&&t.texStorage2D(i.TEXTURE_2D,k,Ne,Ue[0].width,Ue[0].height);for(let V=0,K=Ue.length;V<K;V++)Se=Ue[V],ze?x&&t.texSubImage2D(i.TEXTURE_2D,V,0,0,Se.width,Se.height,_e,qe,Se.data):t.texImage2D(i.TEXTURE_2D,V,Ne,Se.width,Se.height,0,_e,qe,Se.data);M.generateMipmaps=!1}else ze?(rt&&t.texStorage2D(i.TEXTURE_2D,k,Ne,ae.width,ae.height),x&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ae.width,ae.height,_e,qe,ae.data)):t.texImage2D(i.TEXTURE_2D,0,Ne,ae.width,ae.height,0,_e,qe,ae.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){ze&&rt&&t.texStorage3D(i.TEXTURE_2D_ARRAY,k,Ne,Ue[0].width,Ue[0].height,ae.depth);for(let V=0,K=Ue.length;V<K;V++)if(Se=Ue[V],M.format!==Kt)if(_e!==null)if(ze){if(x)if(M.layerUpdates.size>0){const ie=yl(Se.width,Se.height,M.format,M.type);for(const Re of M.layerUpdates){const Oe=Se.data.subarray(Re*ie/Se.data.BYTES_PER_ELEMENT,(Re+1)*ie/Se.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,V,0,0,Re,Se.width,Se.height,1,_e,Oe,0,0)}M.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,V,0,0,0,Se.width,Se.height,ae.depth,_e,Se.data,0,0)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,V,Ne,Se.width,Se.height,ae.depth,0,Se.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else ze?x&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,V,0,0,0,Se.width,Se.height,ae.depth,_e,qe,Se.data):t.texImage3D(i.TEXTURE_2D_ARRAY,V,Ne,Se.width,Se.height,ae.depth,0,_e,qe,Se.data)}else{ze&&rt&&t.texStorage2D(i.TEXTURE_2D,k,Ne,Ue[0].width,Ue[0].height);for(let V=0,K=Ue.length;V<K;V++)Se=Ue[V],M.format!==Kt?_e!==null?ze?x&&t.compressedTexSubImage2D(i.TEXTURE_2D,V,0,0,Se.width,Se.height,_e,Se.data):t.compressedTexImage2D(i.TEXTURE_2D,V,Ne,Se.width,Se.height,0,Se.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):ze?x&&t.texSubImage2D(i.TEXTURE_2D,V,0,0,Se.width,Se.height,_e,qe,Se.data):t.texImage2D(i.TEXTURE_2D,V,Ne,Se.width,Se.height,0,_e,qe,Se.data)}else if(M.isDataArrayTexture)if(ze){if(rt&&t.texStorage3D(i.TEXTURE_2D_ARRAY,k,Ne,ae.width,ae.height,ae.depth),x)if(M.layerUpdates.size>0){const V=yl(ae.width,ae.height,M.format,M.type);for(const K of M.layerUpdates){const ie=ae.data.subarray(K*V/ae.data.BYTES_PER_ELEMENT,(K+1)*V/ae.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,K,ae.width,ae.height,1,_e,qe,ie)}M.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,ae.width,ae.height,ae.depth,_e,qe,ae.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Ne,ae.width,ae.height,ae.depth,0,_e,qe,ae.data);else if(M.isData3DTexture)ze?(rt&&t.texStorage3D(i.TEXTURE_3D,k,Ne,ae.width,ae.height,ae.depth),x&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,ae.width,ae.height,ae.depth,_e,qe,ae.data)):t.texImage3D(i.TEXTURE_3D,0,Ne,ae.width,ae.height,ae.depth,0,_e,qe,ae.data);else if(M.isFramebufferTexture){if(rt)if(ze)t.texStorage2D(i.TEXTURE_2D,k,Ne,ae.width,ae.height);else{let V=ae.width,K=ae.height;for(let ie=0;ie<k;ie++)t.texImage2D(i.TEXTURE_2D,ie,Ne,V,K,0,_e,qe,null),V>>=1,K>>=1}}else if(Ue.length>0){if(ze&&rt){const V=ye(Ue[0]);t.texStorage2D(i.TEXTURE_2D,k,Ne,V.width,V.height)}for(let V=0,K=Ue.length;V<K;V++)Se=Ue[V],ze?x&&t.texSubImage2D(i.TEXTURE_2D,V,0,0,_e,qe,Se):t.texImage2D(i.TEXTURE_2D,V,Ne,_e,qe,Se);M.generateMipmaps=!1}else if(ze){if(rt){const V=ye(ae);t.texStorage2D(i.TEXTURE_2D,k,Ne,V.width,V.height)}x&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,_e,qe,ae)}else t.texImage2D(i.TEXTURE_2D,0,Ne,_e,qe,ae);p(M)&&m(Q),we.__version=ee.version,M.onUpdate&&M.onUpdate(M)}C.__version=M.version}function X(C,M,H){if(M.image.length!==6)return;const Q=ue(C,M),te=M.source;t.bindTexture(i.TEXTURE_CUBE_MAP,C.__webglTexture,i.TEXTURE0+H);const ee=n.get(te);if(te.version!==ee.__version||Q===!0){t.activeTexture(i.TEXTURE0+H);const we=je.getPrimaries(je.workingColorSpace),fe=M.colorSpace===Vn?null:je.getPrimaries(M.colorSpace),ve=M.colorSpace===Vn||we===fe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ve);const Be=M.isCompressedTexture||M.image[0].isCompressedTexture,ae=M.image[0]&&M.image[0].isDataTexture,_e=[];for(let K=0;K<6;K++)!Be&&!ae?_e[K]=_(M.image[K],!0,s.maxCubemapSize):_e[K]=ae?M.image[K].image:M.image[K],_e[K]=de(M,_e[K]);const qe=_e[0],Ne=r.convert(M.format,M.colorSpace),Se=r.convert(M.type),Ue=E(M.internalFormat,Ne,Se,M.colorSpace),ze=M.isVideoTexture!==!0,rt=ee.__version===void 0||Q===!0,x=te.dataReady;let k=y(M,qe);J(i.TEXTURE_CUBE_MAP,M);let V;if(Be){ze&&rt&&t.texStorage2D(i.TEXTURE_CUBE_MAP,k,Ue,qe.width,qe.height);for(let K=0;K<6;K++){V=_e[K].mipmaps;for(let ie=0;ie<V.length;ie++){const Re=V[ie];M.format!==Kt?Ne!==null?ze?x&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ie,0,0,Re.width,Re.height,Ne,Re.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ie,Ue,Re.width,Re.height,0,Re.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):ze?x&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ie,0,0,Re.width,Re.height,Ne,Se,Re.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ie,Ue,Re.width,Re.height,0,Ne,Se,Re.data)}}}else{if(V=M.mipmaps,ze&&rt){V.length>0&&k++;const K=ye(_e[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,k,Ue,K.width,K.height)}for(let K=0;K<6;K++)if(ae){ze?x&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,_e[K].width,_e[K].height,Ne,Se,_e[K].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Ue,_e[K].width,_e[K].height,0,Ne,Se,_e[K].data);for(let ie=0;ie<V.length;ie++){const Oe=V[ie].image[K].image;ze?x&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ie+1,0,0,Oe.width,Oe.height,Ne,Se,Oe.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ie+1,Ue,Oe.width,Oe.height,0,Ne,Se,Oe.data)}}else{ze?x&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,Ne,Se,_e[K]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Ue,Ne,Se,_e[K]);for(let ie=0;ie<V.length;ie++){const Re=V[ie];ze?x&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ie+1,0,0,Ne,Se,Re.image[K]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ie+1,Ue,Ne,Se,Re.image[K])}}}p(M)&&m(i.TEXTURE_CUBE_MAP),ee.__version=te.version,M.onUpdate&&M.onUpdate(M)}C.__version=M.version}function $(C,M,H,Q,te,ee){const we=r.convert(H.format,H.colorSpace),fe=r.convert(H.type),ve=E(H.internalFormat,we,fe,H.colorSpace);if(!n.get(M).__hasExternalTextures){const ae=Math.max(1,M.width>>ee),_e=Math.max(1,M.height>>ee);te===i.TEXTURE_3D||te===i.TEXTURE_2D_ARRAY?t.texImage3D(te,ee,ve,ae,_e,M.depth,0,we,fe,null):t.texImage2D(te,ee,ve,ae,_e,0,we,fe,null)}t.bindFramebuffer(i.FRAMEBUFFER,C),Z(M)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Q,te,n.get(H).__webglTexture,0,he(M)):(te===i.TEXTURE_2D||te>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&te<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Q,te,n.get(H).__webglTexture,ee),t.bindFramebuffer(i.FRAMEBUFFER,null)}function ge(C,M,H){if(i.bindRenderbuffer(i.RENDERBUFFER,C),M.depthBuffer){const Q=M.depthTexture,te=Q&&Q.isDepthTexture?Q.type:null,ee=v(M.stencilBuffer,te),we=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,fe=he(M);Z(M)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,fe,ee,M.width,M.height):H?i.renderbufferStorageMultisample(i.RENDERBUFFER,fe,ee,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,ee,M.width,M.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,we,i.RENDERBUFFER,C)}else{const Q=M.textures;for(let te=0;te<Q.length;te++){const ee=Q[te],we=r.convert(ee.format,ee.colorSpace),fe=r.convert(ee.type),ve=E(ee.internalFormat,we,fe,ee.colorSpace),Be=he(M);H&&Z(M)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Be,ve,M.width,M.height):Z(M)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Be,ve,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,ve,M.width,M.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function se(C,M){if(M&&M.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,C),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(M.depthTexture).__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),z(M.depthTexture,0);const Q=n.get(M.depthTexture).__webglTexture,te=he(M);if(M.depthTexture.format===zi)Z(M)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Q,0,te):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Q,0);else if(M.depthTexture.format===Yi)Z(M)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Q,0,te):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Q,0);else throw new Error("Unknown depthTexture format")}function Ae(C){const M=n.get(C),H=C.isWebGLCubeRenderTarget===!0;if(C.depthTexture&&!M.__autoAllocateDepthBuffer){if(H)throw new Error("target.depthTexture not supported in Cube render targets");se(M.__webglFramebuffer,C)}else if(H){M.__webglDepthbuffer=[];for(let Q=0;Q<6;Q++)t.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer[Q]),M.__webglDepthbuffer[Q]=i.createRenderbuffer(),ge(M.__webglDepthbuffer[Q],C,!1)}else t.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer=i.createRenderbuffer(),ge(M.__webglDepthbuffer,C,!1);t.bindFramebuffer(i.FRAMEBUFFER,null)}function Ie(C,M,H){const Q=n.get(C);M!==void 0&&$(Q.__webglFramebuffer,C,C.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),H!==void 0&&Ae(C)}function be(C){const M=C.texture,H=n.get(C),Q=n.get(M);C.addEventListener("dispose",R);const te=C.textures,ee=C.isWebGLCubeRenderTarget===!0,we=te.length>1;if(we||(Q.__webglTexture===void 0&&(Q.__webglTexture=i.createTexture()),Q.__version=M.version,o.memory.textures++),ee){H.__webglFramebuffer=[];for(let fe=0;fe<6;fe++)if(M.mipmaps&&M.mipmaps.length>0){H.__webglFramebuffer[fe]=[];for(let ve=0;ve<M.mipmaps.length;ve++)H.__webglFramebuffer[fe][ve]=i.createFramebuffer()}else H.__webglFramebuffer[fe]=i.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){H.__webglFramebuffer=[];for(let fe=0;fe<M.mipmaps.length;fe++)H.__webglFramebuffer[fe]=i.createFramebuffer()}else H.__webglFramebuffer=i.createFramebuffer();if(we)for(let fe=0,ve=te.length;fe<ve;fe++){const Be=n.get(te[fe]);Be.__webglTexture===void 0&&(Be.__webglTexture=i.createTexture(),o.memory.textures++)}if(C.samples>0&&Z(C)===!1){H.__webglMultisampledFramebuffer=i.createFramebuffer(),H.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,H.__webglMultisampledFramebuffer);for(let fe=0;fe<te.length;fe++){const ve=te[fe];H.__webglColorRenderbuffer[fe]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,H.__webglColorRenderbuffer[fe]);const Be=r.convert(ve.format,ve.colorSpace),ae=r.convert(ve.type),_e=E(ve.internalFormat,Be,ae,ve.colorSpace,C.isXRRenderTarget===!0),qe=he(C);i.renderbufferStorageMultisample(i.RENDERBUFFER,qe,_e,C.width,C.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.RENDERBUFFER,H.__webglColorRenderbuffer[fe])}i.bindRenderbuffer(i.RENDERBUFFER,null),C.depthBuffer&&(H.__webglDepthRenderbuffer=i.createRenderbuffer(),ge(H.__webglDepthRenderbuffer,C,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ee){t.bindTexture(i.TEXTURE_CUBE_MAP,Q.__webglTexture),J(i.TEXTURE_CUBE_MAP,M);for(let fe=0;fe<6;fe++)if(M.mipmaps&&M.mipmaps.length>0)for(let ve=0;ve<M.mipmaps.length;ve++)$(H.__webglFramebuffer[fe][ve],C,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+fe,ve);else $(H.__webglFramebuffer[fe],C,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0);p(M)&&m(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(we){for(let fe=0,ve=te.length;fe<ve;fe++){const Be=te[fe],ae=n.get(Be);t.bindTexture(i.TEXTURE_2D,ae.__webglTexture),J(i.TEXTURE_2D,Be),$(H.__webglFramebuffer,C,Be,i.COLOR_ATTACHMENT0+fe,i.TEXTURE_2D,0),p(Be)&&m(i.TEXTURE_2D)}t.unbindTexture()}else{let fe=i.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(fe=C.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(fe,Q.__webglTexture),J(fe,M),M.mipmaps&&M.mipmaps.length>0)for(let ve=0;ve<M.mipmaps.length;ve++)$(H.__webglFramebuffer[ve],C,M,i.COLOR_ATTACHMENT0,fe,ve);else $(H.__webglFramebuffer,C,M,i.COLOR_ATTACHMENT0,fe,0);p(M)&&m(fe),t.unbindTexture()}C.depthBuffer&&Ae(C)}function We(C){const M=C.textures;for(let H=0,Q=M.length;H<Q;H++){const te=M[H];if(p(te)){const ee=C.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,we=n.get(te).__webglTexture;t.bindTexture(ee,we),m(ee),t.unbindTexture()}}}const b=[],re=[];function ne(C){if(C.samples>0){if(Z(C)===!1){const M=C.textures,H=C.width,Q=C.height;let te=i.COLOR_BUFFER_BIT;const ee=C.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,we=n.get(C),fe=M.length>1;if(fe)for(let ve=0;ve<M.length;ve++)t.bindFramebuffer(i.FRAMEBUFFER,we.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ve,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,we.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ve,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,we.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,we.__webglFramebuffer);for(let ve=0;ve<M.length;ve++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(te|=i.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(te|=i.STENCIL_BUFFER_BIT)),fe){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,we.__webglColorRenderbuffer[ve]);const Be=n.get(M[ve]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Be,0)}i.blitFramebuffer(0,0,H,Q,0,0,H,Q,te,i.NEAREST),c===!0&&(b.length=0,re.length=0,b.push(i.COLOR_ATTACHMENT0+ve),C.depthBuffer&&C.resolveDepthBuffer===!1&&(b.push(ee),re.push(ee),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,re)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,b))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),fe)for(let ve=0;ve<M.length;ve++){t.bindFramebuffer(i.FRAMEBUFFER,we.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ve,i.RENDERBUFFER,we.__webglColorRenderbuffer[ve]);const Be=n.get(M[ve]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,we.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ve,i.TEXTURE_2D,Be,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,we.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&c){const M=C.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[M])}}}function he(C){return Math.min(s.maxSamples,C.samples)}function Z(C){const M=n.get(C);return C.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function Ce(C){const M=o.render.frame;u.get(C)!==M&&(u.set(C,M),C.update())}function de(C,M){const H=C.colorSpace,Q=C.format,te=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||H!==wt&&H!==Vn&&(je.getTransfer(H)===it?(Q!==Kt||te!==Pn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",H)),M}function ye(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(l.width=C.naturalWidth||C.width,l.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(l.width=C.displayWidth,l.height=C.displayHeight):(l.width=C.width,l.height=C.height),l}this.allocateTextureUnit=Y,this.resetTextureUnits=P,this.setTexture2D=z,this.setTexture2DArray=D,this.setTexture3D=O,this.setTextureCube=j,this.rebindTextures=Ie,this.setupRenderTarget=be,this.updateRenderTargetMipmap=We,this.updateMultisampleRenderTarget=ne,this.setupDepthRenderbuffer=Ae,this.setupFrameBufferTexture=$,this.useMultisampledRTT=Z}function q_(i,e){function t(n,s=Vn){let r;const o=je.getTransfer(s);if(n===Pn)return i.UNSIGNED_BYTE;if(n===Xa)return i.UNSIGNED_SHORT_4_4_4_4;if(n===qa)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Mu)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===xu)return i.BYTE;if(n===yu)return i.SHORT;if(n===ws)return i.UNSIGNED_SHORT;if(n===Wa)return i.INT;if(n===ai)return i.UNSIGNED_INT;if(n===sn)return i.FLOAT;if(n===Fs)return i.HALF_FLOAT;if(n===Su)return i.ALPHA;if(n===Eu)return i.RGB;if(n===Kt)return i.RGBA;if(n===Tu)return i.LUMINANCE;if(n===Au)return i.LUMINANCE_ALPHA;if(n===zi)return i.DEPTH_COMPONENT;if(n===Yi)return i.DEPTH_STENCIL;if(n===Ya)return i.RED;if(n===Ka)return i.RED_INTEGER;if(n===bu)return i.RG;if(n===ja)return i.RG_INTEGER;if(n===Za)return i.RGBA_INTEGER;if(n===Ar||n===br||n===wr||n===Rr)if(o===it)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Ar)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===br)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===wr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Rr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Ar)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===br)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===wr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Rr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===jo||n===Zo||n===Jo||n===$o)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===jo)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Zo)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Jo)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===$o)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Qo||n===ea||n===ta)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Qo||n===ea)return o===it?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===ta)return o===it?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===na||n===ia||n===sa||n===ra||n===oa||n===aa||n===ca||n===la||n===ua||n===ha||n===fa||n===da||n===pa||n===ma)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===na)return o===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===ia)return o===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===sa)return o===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===ra)return o===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===oa)return o===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===aa)return o===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===ca)return o===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===la)return o===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===ua)return o===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===ha)return o===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===fa)return o===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===da)return o===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===pa)return o===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ma)return o===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Cr||n===ga||n===_a)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Cr)return o===it?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===ga)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===_a)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===wu||n===va||n===xa||n===ya)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Cr)return r.COMPRESSED_RED_RGTC1_EXT;if(n===va)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===xa)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===ya)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===qi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class Y_ extends Dt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}let Wn=class extends st{constructor(){super(),this.isGroup=!0,this.type="Group"}};const K_={type:"move"};class Po{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Wn,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Wn,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new I,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new I),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Wn,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new I,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new I),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let s=null,r=null,o=null;const a=this._targetRay,c=this._grip,l=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(l&&e.hand){o=!0;for(const _ of e.hand.values()){const p=t.getJointPose(_,n),m=this._getHandJoint(l,_);p!==null&&(m.matrix.fromArray(p.transform.matrix),m.matrix.decompose(m.position,m.rotation,m.scale),m.matrixWorldNeedsUpdate=!0,m.jointRadius=p.radius),m.visible=p!==null}const u=l.joints["index-finger-tip"],h=l.joints["thumb-tip"],f=u.position.distanceTo(h.position),d=.02,g=.005;l.inputState.pinching&&f>d+g?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!l.inputState.pinching&&f<=d-g&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else c!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,n),r!==null&&(c.matrix.fromArray(r.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,r.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(r.linearVelocity)):c.hasLinearVelocity=!1,r.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(r.angularVelocity)):c.hasAngularVelocity=!1));a!==null&&(s=t.getPose(e.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(K_)))}return a!==null&&(a.visible=s!==null),c!==null&&(c.visible=r!==null),l!==null&&(l.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new Wn;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const j_=`
void main() {
